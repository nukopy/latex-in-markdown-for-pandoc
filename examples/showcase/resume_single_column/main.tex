...
\raisebox{-0.2em}{\includegraphics[height=0.9em]{./assets/LinkedInBlackLogo.png}}~\href{https://example.com}{Joke Jordan}
\textbar{}
\raisebox{-0.2em}{\includegraphics[height=0.9em]{./assets/ZennBlackLogo.png}}~\href{https://example.com}{jokejordan}
